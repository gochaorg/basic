...
var testExpressions = [
    ...
    { code: '-1-2', parseFn: function (p) { return p.expression(); }, json: true, toBasic: true },
    { code: '10*2+7', parseFn: function (p) { return p.expression(); }, debug: true, json: false, toBasic: true },
    { code: '2+7+3', parseFn: function (p) { return p.expression(); }, debug: false, json: false, toBasic: true },
    { code: '2*7*3', parseFn: function (p) { return p.expression(); }, debug: false, json: false, toBasic: true },
];
